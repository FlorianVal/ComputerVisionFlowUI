...
describe('GrayscaleNode', () => {
    beforeEach(() => {
        vi.clearAllMocks()
        // Default mock for useNodeInput (not connected)
    ...
    it('should render with title', () => {
        render(
            <TestWrapper>
                <GrayscaleNode id="test-1" data={{}} selected={false} />
            </TestWrapper>
        )
    ...
    it('should show canvas when input is connected', async () => {
        ...
        const { container } = render(
            <TestWrapper>
                <GrayscaleNode id="test-1" data={{ imageUrl: testUrl }} selected={false} />
            </TestWrapper>
        )
